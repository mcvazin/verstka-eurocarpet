...
<div class="container">
    <ul class="breadcrumb">
        ...
        <li class="crump"><a href="category.php">Линолеум</a></li>
        <li class="current-crump">Линолеум FARSISTAN 5602/675</li>
    </ul>
</div>
...
<section class="container page-good-card">
    <div class="row good-name-row">
        <div class="col-12">
            <h1 class="good-name">Линолеум FARSISTAN 5602/675</h1>
        </div>
        <div class="col-12">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="good-foto-slider sale-good">
            ...
            <div class="row">
                <div class="col-12 good-buy-sizes">
                    <div class="row">
                        ...
                        <div class="col-sm-5 good-counts-price">
